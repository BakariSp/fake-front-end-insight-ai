...
import { Card, Button, SearchBar, Avatar, Badge } from '@ui';
              ...
              <div key={teacher.id} className={styles.teacherCard}>
                ...
                <div className={styles.teacherActions}>
                  <Button 
                    variant="primary" 
                    size="small"
                    onClick={() => window.location.href = `/student/communication?to=${teacher.id}`}
                  >
                    Message
                  </Button>
                  <Button 
            ...
            {students.map((student) => (
              <div key={student.id} className={styles.studentCard}>
                ...
                <Button 
                  ...
                  onClick={() => window.location.href = `/student/communication?to=${student.id}`}
                >
                  Message
                </Button>
              </div>
