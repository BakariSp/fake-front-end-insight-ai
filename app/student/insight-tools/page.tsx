...
export default function InsightToolsPage() {
  ...
  const tools = [
    ...
    },
    {
      ...
      titleZh: '学习统计分析',
      description: 'Comprehensive learning data analysis across all classes with AI-powered insights',
      descriptionZh: '跨班级学习数据全面分析，AI个性化建议',
      icon: '📈',
      category: 'analysis',
      color: '#06B6D4',
      features: ['Class Performance', 'Mistake Analysis', 'Study Habits', 'AI Recommendations'],
      href: '/student/insight-tools/learning-analytics',
      isFavorite: true,
      usageCount: 12,
    },
  ];
