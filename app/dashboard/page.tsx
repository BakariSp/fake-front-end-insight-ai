        ...
        <div className={styles.coursesSection}>
          <Card>
            <div className={styles.sectionHeader}>
              ...
              <Button variant="ghost" size="small" onClick={() => window.location.href = '/class'}>
            ...
            <div className={styles.coursesList}>
              {mockClasses.map((cls) => {
                ...
                <Card 
                  ...
                  onClick={() => window.location.href = `/class/${cls.id}/overview`}
                >
                ...
                upcomingDues.map((assignment) => {
                  ...
                  return (
                    <div 
                      ...
                      onClick={() => window.location.href = `/class/${assignment.classId}/assignments/${assignment.id}`}
                    >
                  ...
                  <div className={styles.calendarClasses}>
                    {day.classes.map((cls, clsIndex) => (
                      <div 
                        ...
                        onClick={() => window.location.href = `/class/${cls.classId}/overview`}
                      >
