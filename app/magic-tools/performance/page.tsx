...
import { Card, Button, Chart, Progress } from '../../components/ui';
    ...
    <MainLayout>
      ...
      <div className={styles.actionsCard}>
        ...
        <div className={styles.actionsGrid}>
          <Button
            variant="primary"
            onClick={() => router.push('/magic-tools/mistake-analysis')}
          >
            Review Mistakes 复习错题
          </Button>
          <Button
            variant="primary"
            onClick={() => router.push('/magic-tools/practice-generator')}
          >
            Practice Weak Areas 针对性练习
          </Button>
          <Button
            variant="secondary"
            onClick={() => router.push('/magic-tools/ai-tutor')}
          >
            Get AI Help 获取AI帮助
          </Button>
          <Button
            variant="secondary"
            onClick={() => router.push('/magic-tools/achievements')}
          >
